...
export default function ContactFormStandalone() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) { setError(data.error ?? "Erreur d'envoi."); return; }
      setSuccess(true);
    } catch {
  ...
  if (success) {
    return (
      <div className="csf csf--success">
        ...
        <h3 className="csf__success-title">Message envoyé !</h3>
        <p className="csf__success-text">
  ...
  return (
    <div className="csf">
      <div className="csf__header">
        <h2 className="csf__title">Envoyer un message</h2>
        <p className="csf__sub">Nous répondons généralement en moins de 24h.</p>
      </div>

      <form onSubmit={handleSubmit} className="csf__form">
        <div className="csf__row">
          <div className="csf__field">
            <label className="csf__label">Nom *</label>
            <input
          ...
          <div className="csf__field">
            <label className="csf__label">Téléphone</label>
            <input
        ...
        <div className="csf__field">
          <label className="csf__label">Email *</label>
          <input
        ...
        <div className="csf__field">
          <label className="csf__label">Sujet</label>
        ...
        <div className="csf__field">
          <label className="csf__label">Message *</label>
          <textarea
            className="csf__input"
      ...
      <style>{`
        ...
        .csf__submit:hover:not(:disabled) {
        ...
        .csf__success-title {
          font-family: var(--font-display);
          font-size: 28px; color: var(--white); font-weight: 400;
        }
