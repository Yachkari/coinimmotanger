  ...
  return (
    <div className="cp page-enter">
        ...
        <div className="container">
          ...
          <p className="cp__sub">
            {lang === 'fr'
              ...
              : "Our team is available to answer all your questions and guide you through your real estate project."}
          </p>
        </div>
      </div>
        ...
        <div className="cp__info">
          ...
          {(fb || ig || wa) && (
            <div className="cp__social reveal reveal-delay-4">
              <span className="cp__social-label">
                {tr(t.footer.followUs, lang)}
              </span>
      ...
      <style>{`
        ...
        @media (max-width: 960px) { .cp__body { grid-template-columns: 1fr; gap: 48px; } }
        ...
        .cp__social-icon:hover { border-color: var(--gold); color: var(--gold); background: rgba(184,151,90,.06); transform: translateY(-2px); }
        .cp__social-icon--wa:hover { border-color: rgba(37,211,102,.4); color: #4cd880; background: rgba(37,211,102,.06); }
      `}</style>
    </div>
  )
}